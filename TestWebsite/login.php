    ...
    <form method="post">
        <div class="d-flex flex-column justify-content-center min-vh-100 align-items-center">
            ...
            <div style="position: relative;">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16" style="position: absolute; top: 50%; right: 10px; transform: translateY(-50%);">
